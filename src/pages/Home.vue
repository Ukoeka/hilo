<template>
    ...
    <div class="committed">
      <div class="left">
        <div class="top">
          <img src="@/assets/images/bothlift.png" alt="">
        </div>
        <div class="bottom">
          <img class="img-60" src="@/assets/images/womanrect.png" alt="">
          <img class="img-40" src="@/assets/images/mannotes.png" alt="">
        </div>
    ...
    <div class="tailored">
      ...
      <div class="right">
        <img src="@/assets/images/deliver.png" alt="">
      </div>
    </div>
    <Carousel></Carousel>
    <div class="faqs">
      ...
      <div class="right">
        <img src="@/assets/images/cartongirl.png" alt="">
      </div>
    </div>
  ...
  <style scoped lang="scss">
    ...
    .committed{
      width: 94%;
      margin-left: 3%;
      background: url('@/assets/images/blackback.png');
      background-repeat: no-repeat;
      background-size: 100%;
      padding: 1.5%;
      border-radius: 15px;
    ...
    .images{
      ...
      .card1{
          background-image: url('@/assets/images/officeremove.png');
          background-repeat: no-repeat;
          background-size: 100%;
        }
        .card2{
      ...
      .card3{
          background-image: url('@/assets/images/homeremove.png');
          background-repeat: no-repeat;
          background-size: 100%;
        }
        .card4{
          background-image: url('@/assets/images/manvan.png');
          background-repeat: no-repeat;
          background-size: 100%;
        }
        .card5{
          background-image: url('@/assets/images/packingservice.png');
          background-repeat: no-repeat;
          background-size: 100%;
        }
        .card6{
          background-image: url('@/assets/images/packingmaterial.png');
          background-repeat: no-repeat;
          background-size: 100%;
        }
        .card7{
