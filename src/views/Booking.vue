<template>
    <div class="d-flex justify-content-between vh-100">
      ...
      <div class="container flex-grow-1 position-relative pt-2 px-5 h-100 overflow-auto" v-show="display">
        ...
        <div class="card p-3 mb-3">
          <div class="d-flex justify-content-between align-items-center mb-2">
            <div class="d-flex align-items-center gap-2 p-3">
              <h2>Assigned</h2>
              <p class="p-1 rounded-1 m-0" style="background: rgba(247, 250, 255, 1); color: rgba(76, 149, 108, 1); line-height: none;">10,000 Quotes</p>
            </div>
      ...
      <div class="container flex-grow-1 h-100 overflow-auto p-5">
        ...
        <div class="rounded-4">
          <div class="d-flex justify-content-between align-items-center p-2 rounded-top" style="background: linear-gradient(rgba(183, 241, 255, 1),rgba(241, 255, 211, 1));">
            ...
            <div class="d-flex jusify-content-between align-items-center p-2 gap-2">
              <p style="background-color: rgba(231, 231, 231, 1);" class="d-flex align-items-center justify-content-center gap-2 rounded p-2 m-0"> <span style="width: 10px; height: 10px;" class="draft-circle rounded-circle"></span> Ongoing</p>
